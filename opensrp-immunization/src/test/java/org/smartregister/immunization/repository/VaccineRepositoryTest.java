...
public class VaccineRepositoryTest extends BaseUnitTest {
    ...
    public void verifyaddTestShouldCallInsertAndUpdate1Time() {
        ...
        Mockito.when(vaccineRepositoryspy.findUnique(ArgumentMatchers.any(SQLiteDatabase.class),
                ArgumentMatchers.any(Vaccine.class))).thenReturn(vaccineToReturn);
    ...
    public void closeTest() {
        ...
        Mockito.verify(vaccineRepository.getWritableDatabase(), Mockito.times(1))
                .update(ArgumentMatchers.eq(VaccineRepository.VACCINE_TABLE_NAME),
