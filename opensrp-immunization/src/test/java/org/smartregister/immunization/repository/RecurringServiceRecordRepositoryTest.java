...
public class RecurringServiceRecordRepositoryTest extends BaseUnitTest {
    ...
    @Test
    public void testAddCallsInsertTimeWhenRecurringServiceIdIsNull() {
        ...
        Mockito.when(recurringServiceRecordRepository.findByBaseEntityIdAndRecurringServiceId(null, null)).thenReturn(null);

        recurringServiceRecordRepository.add(new ServiceRecord());
        Mockito.verify(sqliteDatabase)
                .insert(org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.isNull(), org.mockito.ArgumentMatchers.any(ContentValues.class));
    }
    ...
    @Test
    public void testFindByBaseEntityIdAndRecurringServiceIdInvokesDBQueryAndReturnsCorrectRecordService() {
        String[] columns = RecurringServiceRecordRepository.TABLE_COLUMNS;
        MatrixCursor cursor = new MatrixCursor(columns);
        cursor.addRow(new Object[]{1l, "base-entity-id", "", magicNumber10, 2l, 1509347804l, "", "", "", "team", "teamId", "Unsynced", "", "", 0, "2017-10-20 12:30:40"});
        ...
        ServiceRecord serviceRecord = recurringServiceRecordRepository.findByBaseEntityIdAndRecurringServiceId("base-entity-id", 2l);
        ...
        org.junit.Assert.assertEquals(magicNumber10, (long) serviceRecord.getRecurringServiceId());
    }
